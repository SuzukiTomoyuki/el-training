# -*- encoding: utf-8 -*-
# stub: google_drive 2.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<oauth>.freeze, ["< 1.0.0", ">= 0.3.6"])
      s.add_runtime_dependency(%q<oauth2>.freeze, ["< 2.0.0", ">= 0.5.0"])
      ...
      s.add_dependency(%q<oauth>.freeze, ["< 1.0.0", ">= 0.3.6"])
      s.add_dependency(%q<oauth2>.freeze, ["< 2.0.0", ">= 0.5.0"])
